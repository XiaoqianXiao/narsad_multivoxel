#!/usr/bin/env python3
"""
FDR (Benjamini–Hochberg) correction for voxelwise p-maps (dynamic reinstatement).
...
def main() -> None:
    parser = argparse.ArgumentParser(description="FDR correction for dynamic reinstatement p-maps")
