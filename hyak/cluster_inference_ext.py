#!/usr/bin/env python3
"""
Post-merge cluster-level inference (FWE) for extinction (phase2) searchlight.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Cluster-level inference for extinction (phase2)")
