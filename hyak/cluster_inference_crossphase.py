#!/usr/bin/env python3
"""
Post-merge cluster-level inference (FWE) for cross-phase searchlight.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Cluster-level inference for crossphase")
    parser.add_argument("--project_root", default="/gscratch/fang/NARSAD")
    parser.add_argument("--merged_dir", default="/gscratch/scrubbed/fanglab/xiaoqian/NARSAD/LSS/searchlight/crossphase/merged")
