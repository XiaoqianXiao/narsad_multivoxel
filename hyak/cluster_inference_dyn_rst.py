#!/usr/bin/env python3
"""
Post-merge cluster-level inference (FWE) for dynamic reinstatement searchlight.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Cluster-level inference for dynamic reinstatement")
    parser.add_argument("--project_root", default="/gscratch/fang/NARSAD")
    parser.add_argument("--merged_dir", default="/gscratch/scrubbed/fanglab/xiaoqian/NARSAD/LSS/searchlight/dyn_rst/merged")
    ...
    subj_maps, subj_info = load_subject_maps(args.merged_dir, mask)
