...
Outputs (NPZ, compressed):
  [OUTPUT_DIR]/phase2_X_ext_y_ext_roi_voxels_MemoryFearNetwork.npz
  [OUTPUT_DIR]/phase3_X_reinst_y_reinst_roi_voxels_MemoryFearNetwork.npz
...
PHASE3_OUTPUT_FILE = os.path.join(OUTPUT_DIR, "phase3_X_reinst_y_reinst_roi_voxels_MemoryFearNetwork.npz")
